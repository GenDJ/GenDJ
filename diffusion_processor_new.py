...
class DiffusionProcessor:
    ...
    def run(self, images, prompt, num_inference_steps, strength, use_compel=False, seed=None):
        ...
        try:
            ...
            pass
        # print(f"Reshaped images input shape: {np.shape(images)}")  # Debug statement
        ...
        if use_compel:
            ...
            print(f"batch_size1212: {batch_size}")
        ...
        try:
            ...
            # print(f"Result shape: {np.shape(result)}")  # Debug statement
            return result
