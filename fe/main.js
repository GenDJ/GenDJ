...
//   await sleep(100); // Wait for .2 seconds before attempting to reconnect
//   console.log("woke up");
//   connectWebSocket();
...
// async function startVideoStream(deviceId) {
//   console.log("startVideoStream1212");
...
//       const frame = await imageCapture.grabFrame();
//       const cropX = Math.max(0, (frame.width - FRAME_WIDTH) / 2);
//       const cropY = Math.max(0, (frame.height - FRAME_HEIGHT) / 2);
...
//   var endpoint = PROMPT_ENDPOINT_URL_BASE + encodedPrompt;
